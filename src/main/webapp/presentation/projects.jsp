...
<div class="col-sm-10 col-sm-offset-1">
	<div class="col-sm-10 col-sm-offset-1 form-wrapper">
				...
				<div class="col-xs-12 col-sm-6 col-md-8">
					...
					<center>
						<div class="show-select">
							<button type="button" class="btn btn-primary">ENABLE
								CRITERION SEARCH</button>
						</div>

						<form:select path="criteria" style="min-width:100%;"
							multiple="true" name="criteria" class="criteria-select">
						</form:select>
					</center>
				</div>
		...
		<c:if test="${empty projects}">
			<h1>
				<center>There are no projects to display. Try again using
					different parameters!</center>
			</h1>
		</c:if>
				...
				<div class="row">
					...
					<div class="col-xs-6 col-md-4">
						<p>
							...
							<font color="blue">Finish:</font> ${value.finishDate} <br /> <a
								href="#" class="btn pull-right">More</a>
						</p>
					</div>
				</div>
			</div>
																	...
																	jQuery
																			.each(
																					...
																					function(
																						...
																						select += '<option value="' + criterion.id + '">'
																								+ criterion.title
																								+ '</option>\n';
																					});
