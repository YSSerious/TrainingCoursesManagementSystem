...
<div class="panel panel-primary  table-responsive meeting">
	<div class="panel-heading">
		<h3 class="panel-title">Student list</h3>
	</div>
	<table class="table table-striped table-bordered meeting" id="pagination" data-count-fixed-columns="1" >
		<thead>
			...
			<tr>
				...
				<c:forEach items="${criteria}" var="criterion">
					<td><font size="3"><a href="#" data-toggle="tooltip"
							data-placement="top" title="No mark, yet">-</a></font></td>
				</c:forEach>
			</tr>
		</c:forEach>
		<c:forEach items="${marks}" var="entry">
			<tr>
				...
				<c:forEach items="${entry.value}" var="mark">
					<td><font size="3"><center><a href="#" data-toggle="tooltip"
							data-placement="top" title="${mark.commentary}">${mark.mark}</a></center></font></td>
				</c:forEach>
			</tr>
		</c:forEach>
	</table>
