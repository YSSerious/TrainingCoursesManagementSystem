                ...
                <ul class="list-group " id="attachment-group">
                    <c:forEach items="${attachments}" var="attachment">
                        <li class="list-group-item clearfix">
                            <a href="${attachment.attachmentScope}" class="col-md-2">${attachment.name}</a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <button id="saveAttachment" type="button" class="btn btn-primary" data-dismiss="modal">Save
                        </button>
                    </form>
                </div>
            </div>
    ...
    $(document).ready(function () {
        ...
        $("#saveAttachment").click(function (event) {
            ...
            if (name && link) {
                ...
                $("#attachment-group").append(
                        "<li class='list-group-item  clearfix'>" +
                        "<a href='"+link+"' class='col-md-2'>"+name+"</a>" +
                        "</li>");
